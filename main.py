...
# print("Simple LangGraph Chatbot is ready. Type 'exit' to end the conversation.")
...
#     # Invoke the graph
#     response_state = runnable.invoke(graph_input)
    
#     # Get the AI's response and add to history
